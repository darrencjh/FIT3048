...
(
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY client_attorneys_key (`client_id`) REFERENCES clients (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;


CREATE TABLE IF NOT EXISTS `altattorneys`
(
    `id`        char(36)     NOT NULL,
    `name`      varchar(255) NOT NULL,
    `address`   varchar(255) DEFAULT NULL,
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY client_altattorneys_key (`client_id`) REFERENCES clients (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;


CREATE TABLE IF NOT EXISTS `decisionmakers`
(
    `id`        char(36)     NOT NULL,
    `name`      varchar(255) NOT NULL,
    `dob`       date        DEFAULT NULL,
