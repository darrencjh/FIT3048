                    ...
                    <div class="col-lg-12">
                        <div class="p-5 mt-5">
                            <div class="text-center">
                                ...
                                <h1
                                    <b
                                    class="h2 text-dark mb-4 mt-5" id="login_companyname" >Admin Login
                                        </b>
                                </h1>
                            </div>
                            ...
                            <fieldset>
                                ...
                                echo $this->Form->control('username',['label' => false,'class'=>"form-control bg-transparent font-weight-bold form-control-input mt-5",'id'=>"loginUsername", 'name'=>"username", 'aria-describedby'=>"emailHelp",'placeholder'=>"Username"]);
                            ...
                            <?= $this->Form->button(__('Login'),['class' => 'btn btn-light btn-block mt-5 form-button text-dark font-weight-bold text-uppercase','id'=>'loginSubmit']) ?>
                            <?= $this->Html->link('Forget Password', ['controller' => 'Admins', 'action' => 'resetPasswordEmail'],['class'=>"btn btn-light btn-block mt-5 form-button text-dark font-weight-bold text-uppercase",'id'=>"forgetPassword",'target'=>"_blank"]) ?>
                            <?= $this->Form->end() ?>
                        </div>
                    </div>
                </div>
