                    ...
                    <div class="p-2">
                        ...
                        <div class="d-lg-flex">
                            <div class="w-sm-100 w-lg-50">
                                <input type="email" name="form_fields[email]" id="contact_email" class="" placeholder="Email">
                            </div>
                            <div class="phone_margin_left w-sm-100 w-lg-50">
                                <input type="phone" name="form_fields[field_de7aa95]" id="contact_phone" class="" placeholder="Phone">
                            </div>
                        </div>
                        <input type="text" name="form_fields[field_e4dbda4]" id="contact_referredby" class="" placeholder="Referred by">
