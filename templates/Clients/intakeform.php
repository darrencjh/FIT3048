...
<div id="content">
    ...
    <div class="ff-cell">
        <div class="column-1 ff-t-cell">
            <div class="ff-el-group">
                ...
                <div class="">
                    <input type="text" name="full_name" id="inputGivenName" class="form-control" maxlength="20"
                           required/>
                ...
                <div class="label">
                    ...
                    <a class="d-inline-block" data-bs-toggle="tooltip"
                       ...
                       data-bs-placement="right">
                        <svg class="label" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="15px"
                             width="15px">
                            <path
                ...
                <div class="input" style="font-size: 0;">
                    <div class="ff-el-form-check">
                        <label class="ff-el-form-check-label">
                            <input type="radio" name="is_will" class="ff-el-form-check-input ff-el-form-check-radio"
                                   value="1">
                            <span>Yes</span>
                        </label>
                    </div>
        ...
        <div class="column-1 ff-t-cell">
            <div class="ff-el-group">
                ...
                <div class="input" style="font-size: 0;">
                    <div class="ff-el-form-check">
                        <label class="ff-el-form-check-label">
                            <input type="radio" name="is_powers" class="ff-el-form-check-input ff-el-form-check-radio"
                                   value="1">
                            <span>Yes</span>
                        </label>
                    </div>
        ...
        <div class="column-1 ff-t-cell">
            <div class="ff-el-group">
                ...
                <div class="input" style="font-size: 0;">
                    <div class="ff-el-form-check">
                        <label class="ff-el-form-check-label">
                            <input type="radio" name="is_binding" class="ff-el-form-check-input ff-el-form-check-radio"
                                   value="1">
                            <span>Yes</span>
                        </label>
                    </div>
    ...
    <div class="ff-cell">
        <div class="column-1 ff-t-cell">
            <div class="ff-el-group">
                <div class="label">
                    <label>Do you have any brain-related disorders; memory loss or confusion; or take any medication
                        that could impact on cognitive function?</label>
                </div>
                <div class="input" style="font-size: 0;">
                    <div class="ff-el-form-check">
                        <label class="ff-el-form-check-label">
    ...
    <!--    Recapture and submission button-->
    <div class="last">
        ...
        <div class="float-none text-center mt-3 float-md-end mt-md-0">
            <button type="submit" name="submit" id="submitIntakeform"
                    class="btn btn-shelbourne rounded-pill fw-bold w-100">Submit
            </button>
        </div>
    </div>
